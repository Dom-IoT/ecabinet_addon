...
if not os.path.exists('db.sqlite'):
    ...
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("a","salt", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("b","pepper", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("c","sugar", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("d","flour", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("e","rice", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("f","pasta", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("g","vinegar", 1, 0)')
    cur.execute('INSERT INTO items (item_name, cabinet_id, absent) VALUES ("o","olive oil", 1, 0)')
    con.commit()
